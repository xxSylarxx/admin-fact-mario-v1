...
(function ($) {
    ...
    $.fn.czmChatSupport = function (options) {
        ...
        return this.each(function () {
            ...
            $(czmID).addClass('czm-chat-support czm-chat-support-' + settings.button.style).prepend('<div class="czm-button waves-effect"></div>');
            ...
            if ((settings.button.link.desktop == false) && (settings.button.link.mobile == false) && (settings.popup.persons.length > 0) && ((settings.button.position == 'right') || (settings.button.position == 'left'))) {
                ...
                $('.czm-popup', czmID).prepend('<div class="czm-popup-header"><span class="czm-popup-close waves-effect"></span></div>');
                ...
                for (var p = 0; p < settings.popup.persons.length; p++) {
                    ...
                    $('.czm-popup-persons', czmID).append('<div class="czm-popup-person waves-effect" data-id="' + p + '"><div class="czm-popup-person-content"></div></div>');
