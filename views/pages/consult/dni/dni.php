<div class="tab-base p-relative">
    ...
    <ul class="nav nav-callout">
        ...
        <li class="nav-item waves-effect" onclick="window.open('/consult/dni','_self');">
            <button class="nav-link active" type="button">Consulta DNI</button>
        </li>
    ...
    <div class="tab-content br-bottom">
        ...
        <div class="tab-pane fade show active">
            <h5 class="card-title">Consulta DNI</h5>
            <p>Ingresa el número de DNI a consultar.</p>
        </div>
        ...
        <div>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <button type="button" class="btn btn-primary mt-2 mb-3" onclick="sendAjaxConsult('dni')"><i class="fa fa-search"></i> Consultar</button>
